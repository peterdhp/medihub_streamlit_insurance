    ...
    try: 
        ...
        if insurance_company_code != "Unknown":
            ...
            if not valid_items:  # If no valid items found, return None
                return "The information for these terms cannot be retrieved. Please inform the user to wait for a service update, and provide the best possible response given the limited terms information available."
